...
public abstract class Participant {
    ...
    //Used to add to the bet winnings. Includes losses as well
    public void setBetWinnings(double winning) {
    	betWinnings = betWinnings + winning;
    }
    
    public void setMinusBetWinnings(double losses) {
    	betWinnings = betWinnings - losses;
    }
    
    //Getter to return the total winnings.
    public double getBetWinnings() {
    	return betWinnings;
    }
